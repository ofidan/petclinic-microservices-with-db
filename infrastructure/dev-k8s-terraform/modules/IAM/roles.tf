...
resource "aws_iam_policy_attachment" "attach_for_master" {
  name       = "attachment_for_master_oliver"
...
resource "aws_iam_policy_attachment" "attach_for_worker" {
  name       = "attachment_for_worker_oliver"
